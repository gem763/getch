# Generated by Django 2.2.7 on 2019-12-30 08:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('on', models.ForeignKey(blank=True, limit_choices_to={'model__in': ['user']}, null=True, on_delete=django.db.models.deletion.CASCADE, to='getchapp.Channel')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('src', models.ImageField(max_length=500, upload_to=getchapp.models._image_path)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('avatar_type', models.CharField(choices=[('social', 'social'), ('uploaded', 'uploaded')], default='uploaded', max_length=10)),
                ('on', models.ForeignKey(blank=True, limit_choices_to={'model__in': ['user']}, null=True, on_delete=django.db.models.deletion.CASCADE, to='getchapp.Channel')),
            ],
            options={
                'abstract': False,
